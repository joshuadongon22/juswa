            ...
            <ul>
                {items.map(item => (
                    <li key={item.id}>
                        ...
                        {item.civil_status} : {item.citizenship} : {item.height} : {item.weight} : {item.contact_number} :
                        {item.address} : {item.email} : {item.number_of_siblings} : {item.mother_last_name} : {item.mother_first_name} : 
